          ...
          <div style={{
            ...
            {step === 1 && (
              <>
                ...
                <form onSubmit={handleStep1} style={{
                  ...
                  width: 400, maxWidth: '100%', margin: '38px auto 0',
                }}>
            ...
            {step === 2 && (
              <>
                ...
                <form onSubmit={handleStep2} style={{ display: 'flex', flexDirection: 'column', gap: 12, width: 400, maxWidth: '100%', margin: '38px auto 0' }}>
            ...
            {step === 3 && (
              <>
                ...
                <div style={{ width: 400, maxWidth: '100%', margin: '38px auto 0' }}>
