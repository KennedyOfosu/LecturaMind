    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            flex: 1, overflowY: 'auto', padding: '38px 20px 24px',
            display: 'flex', flexDirection: 'column',
          }}>
            ...
            {step === 2 && (
              <>
                ...
                <form onSubmit={handleStep2} style={{ display: 'flex', flexDirection: 'column', gap: 12, width: 360, maxWidth: '100%', margin: 'auto auto 0' }}>
            ...
            {step === 3 && (
              <>
                ...
                <div style={{ width: 360, maxWidth: '100%', margin: 'auto auto 0' }}>
