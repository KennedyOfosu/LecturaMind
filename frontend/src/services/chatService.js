...
export const chatService = {
  ...
  getStudentSessions: (limit = 8)             => api.get(`/api/chatbot/sessions?limit=${limit}`),
  simplifyMessage:    (response, courseId)    => api.post('/api/chatbot/simplify', { response, course_id: courseId }),
}
